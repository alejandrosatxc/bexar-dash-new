  ...
  return (
    <div className={styles.wrapper}>
        ...
        {/* <div className={styles.wrapper}> */}
          ...
          <div className={styles.box3}>Box3-Graphic or Chart</div>
          <div className={styles.box4}>Box4-Graphic or randomChart</div>
          <div className={styles.box5}>Box5-Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam nam dicta molestiae quo, placeat sapiente
